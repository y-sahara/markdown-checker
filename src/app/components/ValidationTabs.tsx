...
import { ValidationResult, ValidationCategory, ValidationTabsProps, TabInfo } from '../types';
import ValidationResults from './ValidationResults';

const ValidationTabs: React.FC<ValidationTabsProps> = ({ results }) => {
  const [activeTab, setActiveTab] = useState<ValidationCategory>(ValidationCategory.GENERAL);
  ...
  const filteredResults = activeTab === ValidationCategory.GENERAL
    ? results
